...
Connect to the program with netcat:`$ nc verbal-sleep.picoctf.net 57453`

## Solución
- Al principio nos conectamos a la dirección y el puerto dados. A lo cual nos desplegara una serie de texto el cual deberemos de saltar con `enter`, también nos dará opciones a las cuales debemos elegir para poder continuar, seguirá así hasta que nos de la bandera.
```LINUX
BLOODANGELIX-picoctf@webshell:~$ nc verbal-sleep.picoctf.net 57453
