...
```
BLOODANGELIX-picoctf@webshell:~$ nc jupiter.challenges.picoctf.org 32411
Encrypted message:
...
- Nos dice que es un texto cifrado, a lo cual vamos a un decodificador para que nos descifre el texto, ahi se encontrara la bandera.
