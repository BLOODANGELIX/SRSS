...
Can you figure out how this program works to get the flag?Connect to the program with netcat:`$ nc saturn.picoctf.net 51733`The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/525/picker-III.py).

## Solución

```bash
BLOODANGELIX-picoctf@webshell:~$ nc saturn.picoctf.net 51733
==> 1
1: print_table
2: read_variable
3: write_variable
